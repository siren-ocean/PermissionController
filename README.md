## PermissionController from android-12.1.0_r11
...
```
// android-12/out/soong/.intermediates/external/protobuf/libprotobuf-java-lite/android_common/javac/libprotobuf-java-lite.jar
...
```
// android-12/out/soong/.intermediates/packages/apps/PermissionController/permissioncontroller-statsd/android_common_com.android.permission/javac/permissioncontroller-statsd.jar
...
```
// android-12/out/soong/.intermediates/frameworks/libs/modules-utils/java/com/android/modules/utils/build/modules-utils-build_system/android_common/javac/modules-utils-build_system.jar
...
```
// android-12/out/soong/.intermediates/packages/apps/Car/libs/car-ui-lib/oem-apis/car-ui-lib-oem-apis/android_common/turbine/car-ui-lib-oem-apis.jar
implementation files('libs/modules-utils-build_system.jar')
```
![avatar](images/car-ui-lib-oem-apis.png)
...
##### @car-ui-lib: 
```
// android-12/packages/apps/Car/libs/car-ui-lib/car-ui-lib
...
##### @car-rotary-lib: 
```
// android-12/packages/apps/Car/libs/car-ui-lib/car-rotary-lib
implementation project(':car-rotary-lib')
```
![avatar](images/car-rotary-lib.png)
